...
TupleType::TupleType(const IteratorType *iteratorType, const std::vector<const Type *> types)
...
TupleType *TupleType::get(const IteratorType *iteratorType, const std::vector<const Type *> &types)
{
